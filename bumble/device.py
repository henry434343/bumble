    ...
    def load_from_dict(self, config: Dict[str, Any]) -> None:
        ...
        if hfp_configuration:
            self.hfp_configuration = hfp.Configuration(
                ...
                supported_hf_indicators=[getattr(hfp.HfIndicator, feature) for feature in hfp_configuration.get("supported_hf_indicators", [])],
                supported_audio_codecs=[getattr(hfp.AudioCodec, feature) for feature in hfp_configuration.get("supported_audio_codecs", [])],
            )
